...
proc create_hier_cell_window { parentCell nameHier } {
  ...
  connect_bd_net -net slice0_lsb [get_bd_pins y13] [get_bd_pins slice0/lsb]
  connect_bd_net -net slice0_msb [get_bd_pins y12] [get_bd_pins slice0/msb]
  connect_bd_net -net slice1_lsb [get_bd_pins y11] [get_bd_pins slice1/lsb]
  connect_bd_net -net slice1_msb [get_bd_pins y10] [get_bd_pins slice1/msb]
  connect_bd_net -net slice2_lsb [get_bd_pins y9] [get_bd_pins slice2/lsb]
  connect_bd_net -net slice2_msb [get_bd_pins y8] [get_bd_pins slice2/msb]
  connect_bd_net -net slice3_lsb [get_bd_pins y7] [get_bd_pins slice3/lsb]
  connect_bd_net -net slice3_msb [get_bd_pins y6] [get_bd_pins slice3/msb]
  connect_bd_net -net slice4_lsb [get_bd_pins y5] [get_bd_pins slice4/lsb]
  connect_bd_net -net slice4_msb [get_bd_pins y4] [get_bd_pins slice4/msb]
  connect_bd_net -net slice5_lsb [get_bd_pins y3] [get_bd_pins slice5/lsb]
  connect_bd_net -net slice5_msb [get_bd_pins y2] [get_bd_pins slice5/msb]
  connect_bd_net -net slice6_lsb [get_bd_pins y1] [get_bd_pins slice6/lsb]
  connect_bd_net -net slice6_msb [get_bd_pins y0] [get_bd_pins slice6/msb]
...
proc create_hier_cell_dg_filter { parentCell nameHier } {
  ...
  connect_bd_net -net dgfilter0_sum [get_bd_pins dgfilter0/sum] [get_bd_pins pack/In1]
  connect_bd_net -net dgfilter1_sum [get_bd_pins dgfilter1/sum] [get_bd_pins pack/In0]
...
proc create_root_design { parentCell } {
  ...
  set dout [ create_bd_port -dir O -from 21 -to 0 dout ]
  set last_in [ create_bd_port -dir I last_in ]
  set last_out [ create_bd_port -dir O -from 0 -to 0 last_out ]
  set user_in [ create_bd_port -dir I -from 0 -to 0 user_in ]
  set user_out [ create_bd_port -dir O -from 0 -to 0 user_out ]
  ...
  connect_bd_net -net dg_filter_dout [get_bd_ports dout] [get_bd_pins dg_filter/dout]
  connect_bd_net -net dg_filter_last_out [get_bd_ports last_out] [get_bd_pins dg_filter/last_out]
  connect_bd_net -net dg_filter_user_out [get_bd_ports user_out] [get_bd_pins dg_filter/user_out]
  connect_bd_net -net dg_filter_valid_out [get_bd_ports valid_out] [get_bd_pins dg_filter/valid_out]
  connect_bd_net -net din_1 [get_bd_ports din] [get_bd_pins dg_filter/din]
  connect_bd_net -net last_in_1 [get_bd_ports last_in] [get_bd_pins dg_filter/last_in]
  connect_bd_net -net user_in_1 [get_bd_ports user_in] [get_bd_pins dg_filter/user_in]
  connect_bd_net -net valid_in_1 [get_bd_ports valid_in] [get_bd_pins dg_filter/valid_in]
