...
################################################################
# This is a generated script based on design: rgb2y_core
#
...
proc create_hier_cell_rgb2y { parentCell nameHier } {

  variable script_folder

  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_msg_id "BD_TCL-102" "ERROR" "create_hier_cell_rgb2y() - Empty argument(s)!"}
     return
  }
...
proc create_root_design { parentCell } {
  ...
  set RBG [ create_bd_port -dir I -from 23 -to 0 RBG ]
  set y [ create_bd_port -dir O -from 7 -to 0 y ]

  # Create instance: rgb2y
  create_hier_cell_rgb2y [current_bd_instance .] rgb2y

  # Create port connections
  connect_bd_net -net CLK_1 [get_bd_ports CLK] [get_bd_pins rgb2y/CLK]
  connect_bd_net -net RBG_1 [get_bd_ports RBG] [get_bd_pins rgb2y/RBG]
  connect_bd_net -net rgb2y_y [get_bd_ports y] [get_bd_pins rgb2y/y]
